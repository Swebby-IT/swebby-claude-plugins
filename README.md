...
Marketplace di plugin per Claude Code con orchestrazione multi-agente.
...
|--------|----------|-------------|
| multi-agent-orchestrator | 1.2.2 | 58 agenti Sonnet specializzati (20 frontend, 20 backend, 18 specialist) |
| django-orchestrator | 1.0.3 | Orchestrazione multi-agente per Django |
